...
{\textcolor{white}{
	% Name
	{\Huge \bf Vanja Paunovi\'{c}} \\[0.5em]
	% Tagline 
	{\Large Software Engineer and Computer Science Student } \\[0.25em] 
	% Contact data
	{\begin{tabular}{c c c c} 	
	{\tt vana997@gmail.com} & \textbullet 
	& +381 (0)65 541 9360
	\end{tabular}}  \\[0.25em]
	{\begin{tabular}{r c r c r c} 
	\includegraphics[width=1em]{assets/search-homepage.eps} & {\href{https://dzimiks.com}{\tt dzimiks.com}} & \includegraphics[width=1em]{assets/GitHub-Mark.eps} & 
	{\href{https://github.com/dzimiks}{\tt github.com/dzimiks}} & \includegraphics[width=1em]{assets/In-White-2in-TM.eps} & {\href{https://linkedin.com/in/vpaunovic}{\tt linkedin.com/in/vpaunovic}}
	\end{tabular}}
	}
};
\end{tikzpicture}
...
\fillbar{1.5}{2.7}{2016--present} & \mainitem{The Faculty of Computer Science, University UNION} {Bachelor of Science (BS), Computer Science}{Belgrade, Serbia}{} 
	
\sitemize{%
	\sitem GPA: 8.00/10.00
}\vspace{-\baselineskip}\mbox{}	
\\[10pt] % Use consistent spacing to delimit items

\fillbar{0}{1.5}{2012--2016} & \mainitem{\^{C}etrnaesta beogradska gimnazija}{XIV Belgrade Gymnasium}{Belgrade, Serbia}{}
